...
#Peronosporales No HIt 
PS_ITS2_BC_C_Pythiaceae<- subset_taxa(PS_BC_C, Family == "Pythiaceae") 

#Ceratobasidiaceae
PS_ITS2_BC_C_Ceratobasidiaceae<- subset_taxa(PS_BC_C, Family == "Ceratobasidiaceae") 
plot_tree(tax_glom(PS_ITS2_BC_C_Ceratobasidiaceae, 
                   taxrank="Species"),
          method = "sampledodge",
          ladderize="left",
          nodelabf=nodeplotblank, 
...
#Mycosphaerellaceae
PS_ITS2_BC_C_Mycosphaerellaceae<- subset_taxa(PS_BC_C, Family == "Mycosphaerellaceae") 

plot_tree(PS_ITS2_BC_C_Mycosphaerellaceae, "treeonly", label.tips="Species" , ladderize="left")

#Cyphellaceae - No hit 
PS_ITS2_BC_C_Cyphellaceae<- subset_taxa(PS_BC_C, Family == "Cyphellaceae")

#Trichothecium- Hypocreales order - nothing interesting 
PS_ITS2_BC_C_Hypocreales<- subset_taxa(PS_BC_C, Order == "Hypocreales")

plot_tree(tax_glom(PS_ITS2_BC_C_Hypocreales, 
                   taxrank="Species"),
          method = "sampledodge",
          ladderize="left",
          nodelabf=nodeplotblank, 
...
PS_ON_StoneFruits <- subset_samples(PS_ITS2_ON, Plant!="Blueberry")

meta(PS_ON_StoneFruits)
...
```{r Ontario Stone Fruit ANalysis , echo=FALSE, eval=TRUE, include=FALSE, cache=TRUE} 
...
#Apple 
meco_BEE_ON_StoneFruits <- phyloseq2meco(PS_ON_StoneFruits)

 
b1_ON_StoneFruits <- trans_abund$new(dataset =meco_BEE_ON_StoneFruits, 

                      taxrank = "Species", 

                      ntaxa = 50)

b1_ON_StoneFruits$plot_heatmap(facet = c("Plant","Sample.type"),
                color_values = rev(RColorBrewer::brewer.pal(n = 11, 
                                                            name = "Spectral")),
                xtext_keep = FALSE, 
                withmargin = TRUE)
